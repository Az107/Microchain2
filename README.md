...
Installing microchain2 requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
## Exploring microchain2

After building microchain2, you can explore its exports at the Node REPL:
